...
pub use paint::{
    circle, quad, AtlasKey, AtlasKeyImpl, AtlasTextureInfo, AtlasTextureInfoMap, Circle, FillStyle,
    LineCap, LineJoin, Path2D, Primitive, Quad, SkieAtlas, StrokeStyle, Text, TextAlign,
